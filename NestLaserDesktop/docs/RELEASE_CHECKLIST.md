...
- [ ] `dotnet publish -c Release -p:PublishProfile=Properties/PublishProfiles/Portable.pubxml` succeeds
- [ ] dist/portable/ folder contains all files
- [ ] Application launches from portable folder
- [ ] AppData created on first run
...
# Portable publish
dotnet publish NestLaserDesktop.csproj -c Release -p:PublishProfile=Properties/PublishProfiles/Portable.pubxml
```
